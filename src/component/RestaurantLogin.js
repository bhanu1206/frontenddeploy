...
const RestaurantLogin = () => {
    ...
    const handleRegister = () => navigate("/restaurantregister");
    ...
    const handleSubmit = async (e) => {
        ...
        if (!validateForm()) {
          ...
          try {
      const response = await axios.post("http://localhost:8080/restaurant/login", formData);
